...
namespace HospitalSchedule.Controllers
{
    public class RulesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RulesId,WeekHours,Age,ChildAge,InBetweenShiftTime")] Rules rules)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RulesId,WeekHours,Age,ChildAge,InBetweenShiftTime")] Rules rules)
        {
            if (id != rules.RulesId)
            {
                return NotFound();
