...
using HospitalSchedule.Extensions;
using HospitalSchedule.Models;
using HospitalSchedule.Models.AccountViewModel;
...
namespace HospitalSchedule.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
             ...
             HospitalScheduleDbContext context)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Register([Bind("NurseId,Name,Email,CellPhoneNumber,IDCard,BirthDate,Specialty")] Nurse nurse, RegisterViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
